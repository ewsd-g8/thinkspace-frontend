      ...
      if ($("#side-menu").length) {
        ...
        $("#side-menu a").each(function () {
          ...
          if (this.href == pageUrl) {
            ...
            $(this).parent().parent().parent().parent(); // add active to li of the current link
  ...
  (function ($) {
    ...
    (RightBar.prototype.selectOptionsFromConfig = function () {
      ...
      if (config) {
        ...
        $(
          "input[type=checkbox][name=color-scheme-mode][value=" +
            config.mode +
            "]"
        ).prop("checked", true);
        $("input[type=checkbox][name=width][value=" + config.width + "]").prop(
          "checked",
          true
        );
        $(
      ...
      (RightBar.prototype.init = function () {
        ...
        $(document).on("click", "body", function (e) {
          ...
          if ($(e.target).closest(".left-side-menu, .side-nav").length > 0) {
            return;
          }
